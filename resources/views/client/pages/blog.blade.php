...
<div class="w3-col l8 s12">
  ...
  <a href="{{route('blog',['id'=>$data->id])}}"> <img src="{{asset('resources/upload/sanpham/'.$data->hinhanh)}}" alt="Norway" style="width:100%"></a>
    <div class="w3-container">
     <a href="{{route('blog',['id'=>$data->id])}}">  <h3><b>{{$data->tieude}}</b></h3></a>
      <h5>{{$data->mota}}
    ...
    <div class="w3-container">
      ...
      <div class="w3-row">
        <div class="w3-col m8 s12">
          <a href="{{route('blog',['id'=>$data->id])}}"><p><button class="w3-button w3-padding-large w3-white w3-border"><b>Xem thêm »</b></button></p></a>
        </div>
...
<div class="w3-container w3-padding">
  ...
  <img src="{{asset('resources/upload/sanpham/'.$data->hinhanh)}}" style="width:100%">
